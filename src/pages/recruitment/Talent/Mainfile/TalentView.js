...
const TalentView = () => {
  ...
  const {formData, setFormData, talent, setTalent, formVisible, setFormVisible, toggle, setToggle, company, setCompany, location, setLocation, recDelete, setRecDelete
  } = StateTalent()
