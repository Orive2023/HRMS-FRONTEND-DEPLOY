...
const DebitForm = ( {formData, setFormData, setToggle, setFormVisible}) => {
  ...
  const {subType,setSubType, company,setCompany,setPurchaseError, purchaseBy, setPurchaseBy, file, descriptionError, setDescriptionError, description, setDescription, setFile, updatedTotalAmount, genId, setGenId, debit, setDebit, open, setOpen, dateError, setDateError, recDelete, setRecDelete
  } = StateDebit()
  ...
  let buttonCheck =
  formData.debitVoucherId.length > 0 &&
  formData.voucherType.length > 0 &&
  formData.date.length > 0 &&   
  formData.remark.length > 0 &&
  formData.debitVoucherTableId.length > 0 &&
  ...
  //   const companyData = await api.fetchsubType()
  //   setSubType(companyData)
  // };
