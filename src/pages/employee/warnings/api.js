...
export const saveWarning = async (formData) => {
    try{
        await axios.post(
            "http://13.200.246.216:5000/warnings/create/warnings",
            formData
          );
    } catch(error) {
...
export const deleteWarning = async (id) => {
    try{
        await axios.delete(`http://13.200.246.216:5000/warnings/delete/${id}`)
    } catch(error) {
...
export const loadWarning = async () => {
    try {
       const result =  await axios.get(
            "http://13.200.246.216:5000/warnings/get/warnings",
            {
              validateStatus: () => {
                return true;
              },
