...
export const saveTransfer = async (formData) => {
    try{
        await axios.post(
            "http://13.200.246.216:5000/transfers/create/transfers",
            formData
          );
    } catch(error) {
...
export const deleteTransfer = async (id) => {
    try{
        await axios.delete(`http://13.200.246.216:5000/transfers/delete/${id}`)
    } catch(error) {
...
export const loadTransfer = async () => {
    try {
       const result =  await axios.get(
            "http://13.200.246.216:5000/transfers/get/transfers",
            {
              validateStatus: () => {
                return true;
              },
